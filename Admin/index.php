...
<head>
  ...
  <title>PROLOG Admin - Login</title>
              ...
              <div class="col">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome Back !PROLOG Infotech</h1>
                  </div>
                  <?php
                      if (isset($_POST['alogin'])) 
                      {
                        ...
                        $qry = "select * from admin_data where email='" . $email . "' and password='" . $password . "' ";
                        $q = mysqli_query($con, $qry) or die("query fail " . mysqli_error($con));
                        $row = mysqli_fetch_row($q);
                        $acount = mysqli_num_rows($q);
                        $_SESSION['anm']=$row[3];
        
                        if ($acount > 0)
                        {
                          echo "<script> 
                              alert('Admin Login is sucessful') ;
                  ...
                  <form class="user" method="post" >
                    ...
                    <div class="form-group">
                      ...
                      <input type="submit" name="alogin" value="Login" class="btn btn-primary btn-user btn-block">
                  </form>
                  <hr>
